					...
					<div class="card-body text-center">
						...
						<div class="row text-center ">
							<a href="view_books.jsp?bid=<%=b.getBookId()%>"
								class="btn btn-success btn-sm card1"  style="font-weight: bold;">Details</a> <a href=""
								class="btn btn-primary btn-sm card3" style="font-weight: bold;"><i
						...
						<div class="row text-center ">
							...
							<a href="view_books.jsp?bid=<%=b.getBookId()%>"
								...
								class="btn btn-primary btn-sm ml-1" style="font-weight: bold;"><i
								class="fa fa-solid fa-dollar-sign"></i> <%=b.getPrice()%></a>
						</div>
						<%
						}
